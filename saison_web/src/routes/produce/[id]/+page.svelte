      ...
      <div class="meta-data">
         ...
         {#if produce.companions}
          <div class="meta-item">
            ...
            <span class="meta-value">{JSON.parse(produce.companions as unknown as string).join(', ')}</span>
         </div>
         {/if}
         {#if produce.avoid}
          <div class="meta-item">
            <span class="meta-label">Avoid Planting With</span>
            <span class="meta-value">{JSON.parse(produce.avoid as unknown as string).join(', ')}</span>
         </div>
         {/if}
      </div>
    </div>
